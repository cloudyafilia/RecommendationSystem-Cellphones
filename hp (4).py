...
"""Pada tahap ini, kolom `rating` diubah menjadi tipe data `float32` untuk memastikan bahwa data dapat diproses dengan tepat dalam model machine learning. Konversi tipe ini tidak mengubah rentang nilai rating, hanya mengoptimalkan penyimpanan dan kompatibilitas data. Selain itu, nilai minimum dan maksimum rating juga dihitung untuk memberikan gambaran tentang sebaran nilai rating dalam dataset. Dari hasil, terlihat bahwa nilai rating berkisar dari 1.0 hingga 18.0, di mana nilai 18.0 merupakan outlier karena melebihi skala rating yang umum (biasanya 1-10), sehingga perlu ditangani lebih lanjut.
...
### Mapping data user dan cellphone menjadi satu value dan melakukan normalisasi nilai rating
"""
